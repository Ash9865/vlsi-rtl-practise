...
- `combinational/testbenches` — simulation files for the combinational designs.
- `sequential/design` — flip-flop, FSM and traffic-controller designs.
...
Design files use descriptive names such as `half_adder` and `traffic_light_controller`. Testbench files use the same name followed by `_tb`.
